...
int rinex_writer_init(struct mbuf *out,
	...
	mbuf_puts(out, "     3.04           OBSERVATION DATA    G (GPS)             RINEX VERSION / TYPE\n");
	...
	/* Line 10: SYS / # / OBS TYPES — for GPS, list L1C pseudorange + phase + S/N.
	 * Format: "G    N <types...>" where each type is "C1C L1C S1C" etc.
	 * We declare 3 obs types: C1C (L1 C/A pseudorange), L1C (L1 C/A phase),
	 * S1C (L1 C/A SNR). */
	...
	/* Line 12: TIME OF FIRST OBS — filled later, for now a placeholder.
	 * Actually RINEX allows leaving this out if the first epoch is the
	 * start; we'll just put a sensible default. */
	mbuf_puts(out, "  2026     7     2     0     0    0.0000000  GPS         TIME OF FIRST OBS\n");
