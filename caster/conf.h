 ...
 */
#define	SERVER_VERSION_STRING	"Millipede Server 0.5"		// For Server: header
#define	CLIENT_VERSION_STRING	"Millipede Client 0.5"		// User-Agent header, prepended with "NTRIP "
